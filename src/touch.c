...
LCD_PutChar(x+64,y,data%10+48);
LCD_PutChar(x+48,y,data%100/10+48);
LCD_PutChar(x+32,y,data%1000/100+48);
LCD_PutChar(x+16,y,data%10000/1000+48);   // %10000
LCD_PutChar(x,y,data/10000+48);
}
